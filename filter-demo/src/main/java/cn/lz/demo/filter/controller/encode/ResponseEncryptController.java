...
@RestController
@IncludeInterface
@DataEncodeSwitch(responseEncrypt = true, requestEncrypt = false)
@RequestMapping("/responseEncrypt")
@Api(tags = "请求数据不加密、响应数据加密 接口")
public class ResponseEncryptController {
